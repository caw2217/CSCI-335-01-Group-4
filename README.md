...
Cameron Wilson - Traditional models, most of the README, the requirements.txt, and slides
Brandon Santore - Convolutional Neural Network, some of README, and slides
## How to run
